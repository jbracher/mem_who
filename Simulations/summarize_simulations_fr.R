############################################
# Summarize simulation results for French data
...
five_plots(thresholds1_nolog_fr_0.4, thresholds1_nolog_fr_0.9, thresholds1_nolog_fr_0.975,
           ...
           ylim_threshold = ylim_threshold,  approx_expectations = approx_expectations1_nolog_fr,
...
five_plots(thresholds1_fr_0.4, thresholds1_fr_0.9, thresholds1_fr_0.975,
           ...
           peaks_test = peaks_test_fr, range_i.seasons = range_i.seasons,
           ylim_threshold = ylim_threshold, approx_expectations = approx_expectations1_fr,
           approx_sens = approx_sens, approx_spec = approx_spec, approx_ppv = approx_ppv,
...
five_plots(thresholds_nolog_fr_0.4, thresholds_nolog_fr_0.9, thresholds_nolog_fr_0.975,
           ...
           peaks_test = peaks_test_fr, range_i.seasons = range_i.seasons,
           ylim_threshold = ylim_threshold, approx_expectations = approx_expectations_nolog_fr,
...
five_plots(thresholds_fr_0.4, thresholds_fr_0.9, thresholds_fr_0.975,
           ...
           peaks_test = peaks_test_fr, range_i.seasons = range_i.seasons,
           ylim_threshold = ylim_threshold, approx_expectations = approx_expectations_fr,
...
pdf("../Draft/figure/plot_smoothing3_fr_small.pdf", width = 9, height = 5)
...
#            peaks_test = peaks_test_fr, range_i.seasons = range_i.seasons,
#            ylim_threshold = ylim_threshold,  approx_expectations = approx_expectations1_nolog_smoothed3_fr,
...
pdf("../Draft/figure/plot_smoothing7_fr_small.pdf", width = 9, height = 5)
...
#            peaks_test = peaks_test_fr, range_i.seasons = range_i.seasons,
#            ylim_threshold = ylim_threshold,  approx_expectations = approx_expectations1_nolog_smoothed7_fr,
#            approx_sens = NULL, approx_spec = NULL, approx_ppv = NULL,
...
# plot:
pdf("../Draft/figure/plot_t_fr_small.pdf", width = 9, height = 5)

par(mfrow = c(2, 5), mar = c(4, 4, 3, 1), las = 1)
# layout(matrix(c(1:10, rep(11, 5)), ncol = 5, byrow = TRUE), heights = c(1, 1, 0.55))

five_plots(thresholds1_nolog_t_fr_0.4, thresholds1_nolog_t_fr_0.9, thresholds1_nolog_t_fr_0.975,
           exceedance1_nolog_t_fr_0.4, exceedance1_nolog_t_fr_0.9, exceedance1_nolog_t_fr_0.975,
           peaks_test = peaks_test_fr, range_i.seasons = range_i.seasons,
           ylim_threshold = ylim_threshold, approx_expectations = approx_expectations1_nolog_t_fr,
           approx_sens = approx_sens_t, approx_spec = approx_spec_t, approx_ppv = approx_ppv_t,
           main = "natural scale, n = 1, using t-distribution")

five_plots(thresholds1_t_fr_0.4, thresholds1_t_fr_0.9, thresholds1_t_fr_0.975,
           exceedance1_t_fr_0.4, exceedance1_t_fr_0.9, exceedance1_t_fr_0.975,
           peaks_test = peaks_test_fr, range_i.seasons = range_i.seasons,
           ylim_threshold = ylim_threshold, approx_expectations = approx_expectations1_t_fr,
           approx_sens = approx_sens_t, approx_spec = approx_spec_t, approx_ppv = approx_ppv_t,
...
summary_thresholds1_trend3in_fr <- sim_summary(thresholds1_trend3in_fr_0.4, thresholds1_trend3in_fr_0.9, thresholds1_trend3in_fr_0.975,
                                               range_i.seasons, interval = interv)
summary_exceedance1_trend3in_fr <- sim_summary(exceedance1_trend3in_fr_0.4, exceedance1_trend3in_fr_0.9, exceedance1_trend3in_fr_0.975,
                                               range_i.seasons, interval = interv)

summary_thresholds1_trend3out_fr <- sim_summary(thresholds1_trend3out_fr_0.4, thresholds1_trend3out_fr_0.9, thresholds1_trend3out_fr_0.975,
                                                range_i.seasons, interval = interv)
summary_exceedance1_trend3out_fr <- sim_summary(exceedance1_trend3out_fr_0.4, exceedance1_trend3out_fr_0.9, exceedance1_trend3out_fr_0.975,
                                                range_i.seasons, interval = interv)

summary_thresholds1_trendm3in_fr <- sim_summary(thresholds1_trendm3in_fr_0.4, thresholds1_trendm3in_fr_0.9, thresholds1_trendm3in_fr_0.975,
                                                range_i.seasons, interval = interv)
summary_exceedance1_trendm3in_fr <- sim_summary(exceedance1_trendm3in_fr_0.4, exceedance1_trendm3in_fr_0.9, exceedance1_trendm3in_fr_0.975,
                                                range_i.seasons, interval = interv)

summary_thresholds1_trendm3out_fr <- sim_summary(thresholds1_trendm3out_fr_0.4, thresholds1_trendm3out_fr_0.9, thresholds1_trendm3out_fr_0.975,
                                                 range_i.seasons, interval = interv)
summary_exceedance1_trendm3out_fr <- sim_summary(exceedance1_trendm3out_fr_0.4, exceedance1_trendm3out_fr_0.9, exceedance1_trendm3out_fr_0.975,
                                                 range_i.seasons, interval = interv)


summary_thresholds1_trend0in_fr <- sim_summary(thresholds1_trend0in_fr_0.4, thresholds1_trend0in_fr_0.9, thresholds1_trend0in_fr_0.975,
                                               range_i.seasons, interval = interv)
summary_exceedance1_trend0in_fr <- sim_summary(exceedance1_trend0in_fr_0.4, exceedance1_trend0in_fr_0.9, exceedance1_trend0in_fr_0.975,
                                               range_i.seasons, interval = interv)

summary_thresholds1_trend0out_fr <- sim_summary(thresholds1_trend0out_fr_0.4, thresholds1_trend0out_fr_0.9, thresholds1_trend0out_fr_0.975,
                                                range_i.seasons, interval = interv)
summary_exceedance1_trend0out_fr <- sim_summary(exceedance1_trend0out_fr_0.4, exceedance1_trend0out_fr_0.9, exceedance1_trend0out_fr_0.975,
                                                range_i.seasons, interval = interv)


summary_thresholds1_trend7in_fr <- sim_summary(thresholds1_trend7in_fr_0.4, thresholds1_trend7in_fr_0.9, thresholds1_trend7in_fr_0.975,
                                               range_i.seasons, interval = interv)
summary_exceedance1_trend7in_fr <- sim_summary(exceedance1_trend7in_fr_0.4, exceedance1_trend7in_fr_0.9, exceedance1_trend7in_fr_0.975,
                                               range_i.seasons, interval = interv)

summary_thresholds1_trend7out_fr <- sim_summary(thresholds1_trend7out_fr_0.4, thresholds1_trend7out_fr_0.9, thresholds1_trend7out_fr_0.975,
                                                range_i.seasons, interval = interv)
summary_exceedance1_trend7out_fr <- sim_summary(exceedance1_trend7out_fr_0.4, exceedance1_trend7out_fr_0.9, exceedance1_trend7out_fr_0.975,
                                                range_i.seasons, interval = interv)


summary_thresholds1_trendm7in_fr <- sim_summary(thresholds1_trendm7in_fr_0.4, thresholds1_trendm7in_fr_0.9, thresholds1_trendm7in_fr_0.975,
                                               range_i.seasons, interval = interv)
summary_exceedance1_trendm7in_fr <- sim_summary(exceedance1_trendm7in_fr_0.4, exceedance1_trendm7in_fr_0.9, exceedance1_trendm7in_fr_0.975,
                                               range_i.seasons, interval = interv)

summary_thresholds1_trendm7out_fr <- sim_summary(thresholds1_trendm7out_fr_0.4, thresholds1_trendm7out_fr_0.9, thresholds1_trendm7out_fr_0.975,
                                                range_i.seasons, interval = interv)
summary_exceedance1_trendm7out_fr <- sim_summary(exceedance1_trendm7out_fr_0.4, exceedance1_trendm7out_fr_0.9, exceedance1_trendm7out_fr_0.975,
                                                range_i.seasons, interval = interv)



# plot:
pdf("../Draft/figure/plot_trend3_fr_small.pdf", width = 9, height = 5)

par(mfrow = c(2, 4), mar = c(4, 4, 3, 1), las = 1)

plot_sim_summary(summary_thresholds1_trend3out_fr, xlab = "# included seasons m", ylab = "threshold", ylim = ylim_threshold)
plot_exceedance_summary(summary_exceedance1_trend3out_fr, xlab = "# included seasons m", ylab = "average share")
mtext("3% yearly growth, n = 1, trend ignored", 3, at = 0, line = lin, cex = ce)

plot_sim_summary(summary_thresholds1_trend3in_fr, xlab = "# included seasons m", ylab = "threshold", ylim = ylim_threshold)
plot_exceedance_summary(summary_exceedance1_trend3in_fr, xlab = "# included seasons m", ylab = "average share")
mtext("3% yearly growth, n = 1, trend accounted", 3, at = 0, line = lin, cex = ce)


plot_sim_summary(summary_thresholds1_trendm3out_fr, xlab = "# included seasons m", ylab = "threshold", ylim = ylim_threshold)
plot_exceedance_summary(summary_exceedance1_trendm3out_fr, xlab = "# included seasons m", ylab = "average share")
mtext("-3% yearly growth, n = 1, trend ignored", 3, at = 0, line = lin, cex = ce)

plot_sim_summary(summary_thresholds1_trendm3in_fr, xlab = "# included seasons m", ylab = "threshold", ylim = ylim_threshold)
plot_exceedance_summary(summary_exceedance1_trendm3in_fr, xlab = "# included seasons m", ylab = "average share")
mtext("-3% yearly growth, n = 1, trend accounted", 3, at = 0, line = lin, cex = ce)
...
# plot:
pdf("../Draft/figure/plot_trend7_fr_small.pdf", width = 9, height = 5)

par(mfrow = c(2, 4), mar = c(4, 4, 3, 1), las = 1)

plot_sim_summary(summary_thresholds1_trend7out_fr, xlab = "# included seasons m", ylab = "threshold", ylim = ylim_threshold)
plot_exceedance_summary(summary_exceedance1_trend7out_fr, xlab = "# included seasons m", ylab = "average share")
mtext("7% yearly growth, n = 1, trend ignored", 3, at = 0, line = lin, cex = ce)

plot_sim_summary(summary_thresholds1_trend7in_fr, xlab = "# included seasons m", ylab = "threshold", ylim = ylim_threshold)
plot_exceedance_summary(summary_exceedance1_trend7in_fr, xlab = "# included seasons m", ylab = "average share")
mtext("7% yearly growth, n = 1, trend accounted", 3, at = 0, line = lin, cex = ce)


plot_sim_summary(summary_thresholds1_trendm7out_fr, xlab = "# included seasons m", ylab = "threshold", ylim = ylim_threshold)
plot_exceedance_summary(summary_exceedance1_trendm7out_fr, xlab = "# included seasons m", ylab = "average share")
mtext("-7% yearly growth, n = 1, trend ignored", 3, at = 0, line = lin, cex = ce)

plot_sim_summary(summary_thresholds1_trendm7in_fr, xlab = "# included seasons m", ylab = "threshold", ylim = ylim_threshold)
plot_exceedance_summary(summary_exceedance1_trendm7in_fr, xlab = "# included seasons m", ylab = "average share")
mtext("-7% yearly growth, n = 1, trend accounted", 3, at = 0, line = lin, cex = ce)

dev.off()


# plot sensitivity, specificity, PPV in absence of trend, but with trend accounted for or not:

# compute relevant summaries:
summary_sens_spec_trend0in_fr <- summarize_sens_spec(thresholds1_trend0in_fr_0.4, 
                                                     thresholds1_trend0in_fr_0.9,
                                                     thresholds1_trend0in_fr_0.975,
                                                     peaks_test_fr, range_i.seasons)
summary_ppv_npv_trend0in_fr <- summarize_ppv_npv(thresholds1_trend0in_fr_0.4, 
                                                     thresholds1_trend0in_fr_0.9,
                                                     thresholds1_trend0in_fr_0.975,
                                                     peaks_test_fr, range_i.seasons)

summary_sens_spec_trend0out_fr <- summarize_sens_spec(thresholds1_trend0out_fr_0.4, 
                                                     thresholds1_trend0out_fr_0.9,
                                                     thresholds1_trend0out_fr_0.975,
                                                     peaks_test_fr, range_i.seasons)
summary_ppv_npv_trend0out_fr <- summarize_ppv_npv(thresholds1_trend0out_fr_0.4, 
                                                 thresholds1_trend0out_fr_0.9,
                                                 thresholds1_trend0out_fr_0.975,
                                                 peaks_test_fr, range_i.seasons)

summary_sens_spec_trend3in_fr <- summarize_sens_spec(thresholds1_trend3in_fr_0.4, 
                                                     thresholds1_trend3in_fr_0.9,
                                                     thresholds1_trend3in_fr_0.975,
                                                     peaks_test_fr, range_i.seasons)
summary_ppv_npv_trend3in_fr <- summarize_ppv_npv(thresholds1_trend3in_fr_0.4, 
                                                 thresholds1_trend3in_fr_0.9,
                                                 thresholds1_trend3in_fr_0.975,
                                                 peaks_test_fr, range_i.seasons)

summary_sens_spec_trend3out_fr <- summarize_sens_spec(thresholds1_trend3out_fr_0.4, 
                                                      thresholds1_trend3out_fr_0.9,
                                                      thresholds1_trend3out_fr_0.975,
                                                      peaks_test_fr, range_i.seasons)
summary_ppv_npv_trend3out_fr <- summarize_ppv_npv(thresholds1_trend3out_fr_0.4, 
                                                  thresholds1_trend3out_fr_0.9,
                                                  thresholds1_trend3out_fr_0.975,
                                                  peaks_test_fr, range_i.seasons)

summary_sens_spec_trendm3in_fr <- summarize_sens_spec(thresholds1_trendm3in_fr_0.4, 
                                                      thresholds1_trendm3in_fr_0.9,
                                                      thresholds1_trendm3in_fr_0.975,
                                                      peaks_test_fr, range_i.seasons)
summary_ppv_npv_trendm3in_fr <- summarize_ppv_npv(thresholds1_trendm3in_fr_0.4, 
                                                  thresholds1_trendm3in_fr_0.9,
                                                  thresholds1_trendm3in_fr_0.975,
                                                  peaks_test_fr, range_i.seasons)

summary_sens_spec_trendm3out_fr <- summarize_sens_spec(thresholds1_trendm3out_fr_0.4, 
                                                       thresholds1_trendm3out_fr_0.9,
                                                       thresholds1_trendm3out_fr_0.975,
                                                       peaks_test_fr, range_i.seasons)
summary_ppv_npv_trendm3out_fr <- summarize_ppv_npv(thresholds1_trendm3out_fr_0.4, 
                                                   thresholds1_trendm3out_fr_0.9,
                                                   thresholds1_trendm3out_fr_0.975,
                                                   peaks_test_fr, range_i.seasons)


summary_sens_spec_trend7in_fr <- summarize_sens_spec(thresholds1_trend7in_fr_0.4, 
                                                     thresholds1_trend7in_fr_0.9,
                                                     thresholds1_trend7in_fr_0.975,
                                                     peaks_test_fr, range_i.seasons)
summary_ppv_npv_trend7in_fr <- summarize_ppv_npv(thresholds1_trend7in_fr_0.4, 
                                                 thresholds1_trend7in_fr_0.9,
                                                 thresholds1_trend7in_fr_0.975,
                                                 peaks_test_fr, range_i.seasons)

summary_sens_spec_trend7out_fr <- summarize_sens_spec(thresholds1_trend7out_fr_0.4, 
                                                      thresholds1_trend7out_fr_0.9,
                                                      thresholds1_trend7out_fr_0.975,
                                                      peaks_test_fr, range_i.seasons)
summary_ppv_npv_trend7out_fr <- summarize_ppv_npv(thresholds1_trend7out_fr_0.4, 
                                                  thresholds1_trend7out_fr_0.9,
                                                  thresholds1_trend7out_fr_0.975,
                                                  peaks_test_fr, range_i.seasons)

summary_sens_spec_trendm7in_fr <- summarize_sens_spec(thresholds1_trendm7in_fr_0.4, 
                                                      thresholds1_trendm7in_fr_0.9,
                                                      thresholds1_trendm7in_fr_0.975,
                                                      peaks_test_fr, range_i.seasons)
summary_ppv_npv_trendm7in_fr <- summarize_ppv_npv(thresholds1_trendm7in_fr_0.4, 
                                                  thresholds1_trendm7in_fr_0.9,
                                                  thresholds1_trendm7in_fr_0.975,
                                                  peaks_test_fr, range_i.seasons)

summary_sens_spec_trendm7out_fr <- summarize_sens_spec(thresholds1_trendm7out_fr_0.4, 
                                                       thresholds1_trendm7out_fr_0.9,
                                                       thresholds1_trendm7out_fr_0.975,
                                                       peaks_test_fr, range_i.seasons)
summary_ppv_npv_trendm7out_fr <- summarize_ppv_npv(thresholds1_trendm7out_fr_0.4, 
                                                   thresholds1_trendm7out_fr_0.9,
                                                   thresholds1_trendm7out_fr_0.975,
                                                   peaks_test_fr, range_i.seasons)


pdf("../Draft/figure/plot_cost_trend_fr.pdf", width = 9, height = 13)
layout(matrix(c(1:15, rep(16, 3)), ncol = 3, byrow = TRUE), heights = c(rep(1, 5), 0.7))

par(mar = c(4, 4, 3, 1), las = 1)
plot_sim_summary(summary_sens_spec_trend0out_fr, xlab = "# included seasons m", ylab = "sensitivity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "sens", hlines = 0:5/5)
plot_sim_summary(summary_sens_spec_trend0in_fr, xlab = "# included seasons m", ylab = "sensitivity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "sens", hlines = 0:5/5,
                 add = TRUE, pch = 0)


plot_sim_summary(summary_sens_spec_trend0out_fr, xlab = "# included seasons m", ylab = "specificity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "spec", hlines = 0:5/5)
plot_sim_summary(summary_sens_spec_trend0in_fr, xlab = "# included seasons m", ylab = "specificity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "spec", hlines = 0:5/5,
                 add = TRUE, pch = 0)
mtext("no yearly growth, trend accounted vs not accounted, log-transformed, n = 1", line = lin, cex = ce)

plot_sim_summary(summary_ppv_npv_trend0out_fr, xlab = "# included seasons m", ylab = "PPV",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "ppv", hlines = 0:5/5)
plot_sim_summary(summary_ppv_npv_trend0in_fr, xlab = "# included seasons m", ylab = "PPV",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "ppv", hlines = 0:5/5,
                 add = TRUE, pch = 0)



plot_sim_summary(summary_sens_spec_trend3out_fr, xlab = "# included seasons m", ylab = "sensitivity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "sens", hlines = 0:5/5)
plot_sim_summary(summary_sens_spec_trend3in_fr, xlab = "# included seasons m", ylab = "sensitivity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "sens", hlines = 0:5/5,
                 add = TRUE, pch = 0)


plot_sim_summary(summary_sens_spec_trend3out_fr, xlab = "# included seasons m", ylab = "specificity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "spec", hlines = 0:5/5)
plot_sim_summary(summary_sens_spec_trend3in_fr, xlab = "# included seasons m", ylab = "specificity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "spec", hlines = 0:5/5,
                 add = TRUE, pch = 0)
mtext("3% growth, trend accounted vs not accounted, log-transformed, n = 1", line = lin, cex = ce)

plot_sim_summary(summary_ppv_npv_trend3out_fr, xlab = "# included seasons m", ylab = "PPV",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "ppv", hlines = 0:5/5)
plot_sim_summary(summary_ppv_npv_trend3in_fr, xlab = "# included seasons m", ylab = "PPV",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "ppv", hlines = 0:5/5,
                 add = TRUE, pch = 0)



plot_sim_summary(summary_sens_spec_trendm3out_fr, xlab = "# included seasons m", ylab = "sensitivity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "sens", hlines = 0:5/5)
plot_sim_summary(summary_sens_spec_trendm3in_fr, xlab = "# included seasons m", ylab = "sensitivity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "sens", hlines = 0:5/5,
                 add = TRUE, pch = 0)


plot_sim_summary(summary_sens_spec_trendm3out_fr, xlab = "# included seasons m", ylab = "specificity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "spec", hlines = 0:5/5)
plot_sim_summary(summary_sens_spec_trendm3in_fr, xlab = "# included seasons m", ylab = "specificity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "spec", hlines = 0:5/5,
                 add = TRUE, pch = 0)
mtext("-3% growth, trend accounted vs not accounted, log-transformed, n = 1", line = lin, cex = ce)

plot_sim_summary(summary_ppv_npv_trendm3out_fr, xlab = "# included seasons m", ylab = "PPV",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "ppv", hlines = 0:5/5)
plot_sim_summary(summary_ppv_npv_trendm3in_fr, xlab = "# included seasons m", ylab = "PPV",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "ppv", hlines = 0:5/5,
                 add = TRUE, pch = 0)



plot_sim_summary(summary_sens_spec_trend7out_fr, xlab = "# included seasons m", ylab = "sensitivity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "sens", hlines = 0:5/5)
plot_sim_summary(summary_sens_spec_trend7in_fr, xlab = "# included seasons m", ylab = "sensitivity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "sens", hlines = 0:5/5,
                 add = TRUE, pch = 0)


plot_sim_summary(summary_sens_spec_trend7out_fr, xlab = "# included seasons m", ylab = "specificity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "spec", hlines = 0:5/5)
plot_sim_summary(summary_sens_spec_trend7in_fr, xlab = "# included seasons m", ylab = "specificity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "spec", hlines = 0:5/5,
                 add = TRUE, pch = 0)
mtext("7% yearly growth, trend accounted vs not accounted, log-transformed, n = 1", line = lin, cex = ce)

plot_sim_summary(summary_ppv_npv_trend7out_fr, xlab = "# included seasons m", ylab = "PPV",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "ppv", hlines = 0:5/5)
plot_sim_summary(summary_ppv_npv_trend7in_fr, xlab = "# included seasons m", ylab = "PPV",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "ppv", hlines = 0:5/5,
                 add = TRUE, pch = 0)


plot_sim_summary(summary_sens_spec_trendm7out_fr, xlab = "# included seasons m", ylab = "sensitivity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "sens", hlines = 0:5/5)
plot_sim_summary(summary_sens_spec_trendm7in_fr, xlab = "# included seasons m", ylab = "sensitivity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "sens", hlines = 0:5/5,
                 add = TRUE, pch = 0)


plot_sim_summary(summary_sens_spec_trendm7out_fr, xlab = "# included seasons m", ylab = "specificity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "spec", hlines = 0:5/5)
plot_sim_summary(summary_sens_spec_trendm7in_fr, xlab = "# included seasons m", ylab = "specificity",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "spec", hlines = 0:5/5,
                 add = TRUE, pch = 0)
mtext("-7% growth, trend accounted vs not accounted, log-transformed, n = 1", line = lin, cex = ce)

plot_sim_summary(summary_ppv_npv_trendm7out_fr, xlab = "# included seasons m", ylab = "PPV",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "ppv", hlines = 0:5/5)
plot_sim_summary(summary_ppv_npv_trendm7in_fr, xlab = "# included seasons m", ylab = "PPV",
                 ylim = 0:1, show_bands = FALSE, variable_to_plot = "ppv", hlines = 0:5/5,
                 add = TRUE, pch = 0)
...
# with log trafo
cm1_t_fr_5 <- classification_matrix(thresholds1_t_fr_0.4, thresholds1_t_fr_0.9, thresholds1_t_fr_0.975, peaks_test = peaks_test_fr, i.seasons = 5)
cm1_t_fr_10 <- classification_matrix(thresholds1_t_fr_0.4, thresholds1_t_fr_0.9, thresholds1_t_fr_0.975, peaks_test = peaks_test_fr, i.seasons = 10)
cm1_t_fr_15 <- classification_matrix(thresholds1_t_fr_0.4, thresholds1_t_fr_0.9, thresholds1_t_fr_0.975, peaks_test = peaks_test_fr, i.seasons = 15)

# without:
cm1_nolog_t_fr_5 <- classification_matrix(thresholds1_nolog_t_fr_0.4, thresholds1_nolog_t_fr_0.9, thresholds1_nolog_t_fr_0.975, peaks_test = peaks_test_fr, i.seasons = 5)
cm1_nolog_t_fr_10 <- classification_matrix(thresholds1_nolog_t_fr_0.4, thresholds1_nolog_t_fr_0.9, thresholds1_nolog_t_fr_0.975, peaks_test = peaks_test_fr, i.seasons = 10)
cm1_nolog_t_fr_15 <- classification_matrix(thresholds1_nolog_t_fr_0.4, thresholds1_nolog_t_fr_0.9, thresholds1_nolog_t_fr_0.975, peaks_test = peaks_test_fr, i.seasons = 15)



pdf("../Draft/figure/mosaic_t_fr.pdf", width = 9, height = 6)
# structure plot area:
layout(matrix(c(1, 2, 3, 4,
                5, 6, 7, 8,
                9, 9, 9, 9), nrow = 3, byrow = TRUE), widths = c(0.5, 1, 1, 1), heights = c(1, 1, 0.2))
...
# mosaic plots:
par(mar = c(4, 0.5, 3.5, 3.5), las = 1)
mosaic(cm1_nolog_t_fr_5)
mtext("m = 5", cex = 0.9)
mosaic(cm1_nolog_t_fr_10)
mtext("m = 10", cex = 0.9)
mtext("natural scale, n = 1, using t-distribution", cex = 1, line = 2)
mosaic(cm1_nolog_t_fr_15)
mtext("m = 15", cex = 0.9)
