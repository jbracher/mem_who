...
#      summary_thresholds_us, summary_thresholds1_us, summary_thresholds_nolog_us, summary_thresholds1_nolog_us,
#      summary_exceedance_us, summary_exceedance1_us, summary_exceedance_nolog_us, summary_exceedance1_nolog_us,
...
five_plots(thresholds1_nolog_us_0.4, thresholds1_nolog_us_0.9, thresholds1_nolog_us_0.975,
           ...
           ylim_threshold = c(0, 500),  approx_expectations = approx_expectations1_nolog_us,
...
five_plots(thresholds1_us_0.4, thresholds1_us_0.9, thresholds1_us_0.975,
           ...
           peaks_test = peaks_test_us, range_i.seasons = range_i.seasons,
           ylim_threshold = c(0, 500), approx_expectations = approx_expectations1_us,
           approx_sens = approx_sens, approx_spec = approx_spec, approx_ppv = approx_ppv,
...
five_plots(thresholds_nolog_us_0.4, thresholds_nolog_us_0.9, thresholds_nolog_us_0.975,
           ...
           peaks_test = peaks_test_us, range_i.seasons = range_i.seasons,
           ylim_threshold = c(0, 500), approx_expectations = approx_expectations_nolog_us,
...
five_plots(thresholds_us_0.4, thresholds_us_0.9, thresholds_us_0.975,
           ...
           peaks_test = peaks_test_us, range_i.seasons = range_i.seasons,
           ylim_threshold = c(0, 500), approx_expectations = approx_expectations_us,
...
pdf("../Draft/figure/plot_smoothing3_us_small.pdf", width = 9, height = 8)
...
#            peaks_test = peaks_test_us, range_i.seasons = range_i.seasons,
#            ylim_threshold = c(0, 500),  approx_expectations = approx_expectations1_nolog_smoothed3_us,
...
pdf("../Draft/figure/plot_smoothing7_us_small.pdf", width = 9, height = 6)
...
#            peaks_test = peaks_test_us, range_i.seasons = range_i.seasons,
#            ylim_threshold = c(0, 500),  approx_expectations = approx_expectations1_nolog_smoothed7_us,
#            approx_sens = NULL, approx_spec = NULL, approx_ppv = NULL,
...
# load(paste0("Results/results_ci_nolog_us.rda"))
# load(paste0("Results/results1_ci_nolog_us.rda"))
...
summary_exceedance1_ci_us <- sim_summary(exceedance1_ci_us_0.4, exceedance1_ci_us_0.9, exceedance1_ci_us_0.975,
                                         range_i.seasons, interval = interv)
# summary_thresholds_ci_nolog_us <- sim_summary(thresholds_ci_nolog_us_0.4, thresholds_ci_nolog_us_0.9, thresholds_ci_nolog_us_0.975,
#                                               range_i.seasons, interval = interv)
# summary_exceedance_ci_nolog_us <- sim_summary(exceedance_ci_nolog_us_0.4, exceedance_ci_nolog_us_0.9, exceedance_ci_nolog_us_0.975,
#                                               range_i.seasons, interval = interv)
# summary_thresholds1_ci_nolog_us <- sim_summary(thresholds1_ci_nolog_us_0.4, thresholds1_ci_nolog_us_0.9, thresholds1_ci_nolog_us_0.975,
#                                                range_i.seasons, interval = interv)
# summary_exceedance1_ci_nolog_us <- sim_summary(exceedance1_ci_nolog_us_0.4, exceedance1_ci_nolog_us_0.9, exceedance1_ci_nolog_us_0.975,
#                                                range_i.seasons, interval = interv)
...
pdf("../Draft/figure/mosaic_us_fancy.pdf", width = 9, height = 11)
# structure plot area:
...
pdf("../Draft/figure/mosaic_log_smoothed_us_fancy.pdf", width = 9, height = 6)
# structure plot area:
layout(matrix(c(1, 2, 3, 4,
                5, 6, 7, 8,
